...
module.exports = function (reporter, definition) {
  ...
  reporter.extensionsManager.recipes.push({
    ...
    execute: function (request, response) {
      ...
      response.headers['Content-Disposition'] = request.template.contentDisposition + (
          request.template.contentDisposition.indexOf(';') !== -1 ? '' : ';filename=report.' + request.template.fileExtension)
    }
  })
}
