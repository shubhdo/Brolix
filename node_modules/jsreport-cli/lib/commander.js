...
// homedir folder should normally exist, however it is somehow crippled in azure web app environment
// this extra call shouldn't hurt any other environment and makes the keepAlive working also in azure web apps
tryCreate(homedir)
...
var Commander = module.exports = function Commander (cwd, options) {
  ...
  // and not try to look up for it
  self._jsreportVersion = opts.jsreportVersion
        ...
        cliHandler.parse(args, function (error, argv, output) {
          ...
          if (versionRequired) {
            return handleVersionOption(
              self._jsreportVersion ? {
                version: self._jsreportVersion
